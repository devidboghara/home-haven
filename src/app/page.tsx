    ...
    <main className="relative min-h-screen bg-[#F8FAFC]">
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1600" className="w-full h-full object-cover brightness-[0.5]" alt="Hero" />
        </div>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="relative z-20 text-center px-6 mb-10">
          <h2 className="text-6xl md:text-[10rem] font-black text-white tracking-tighter uppercase italic italic italic italic leading-[0.8] drop-shadow-2xl">Luxe<span className="text-blue-500">Lair.</span></h2>
        </motion.div>

        {/* SEARCH BAR */}
        <div className="relative z-30 w-full max-w-2xl px-6">
          <div className="bg-white p-2 rounded-[2.5rem] shadow-2xl flex items-center border border-slate-100">
